...
class MyFitsDatalakeStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, source_bucket_name: str, glue_database_name: str, **kwargs) -> None:
        ...
        # get the source bucket - this object is an IBucketProxy interface not a Buckt construct. Can not be used to add an event directly.
        ...
        # the custom resource creation makes an SDK call to create the event notification on the bucket
